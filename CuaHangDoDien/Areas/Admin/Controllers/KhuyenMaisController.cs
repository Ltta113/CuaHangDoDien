...
namespace CuaHangDoDien.Areas.Admin.Controllers
{
    public class KhuyenMaisController : LoginManagerController
    {
        ...
        public ActionResult Create([Bind(Include = "ID_KM,BatDauKM,KetThucKM,NoiDungKM,LoaiKM")] KhuyenMai khuyenMai)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_KM,BatDauKM,KetThucKM,NoiDungKM,LoaiKM")] KhuyenMai khuyenMai)
        {
            if (ModelState.IsValid)
            {
