...
namespace CuaHangDoDien.Areas.Admin.Controllers
{
    public class SanPhamsController : LoginManagerController
    {
        ...
        public ActionResult Create([Bind(Include = "ID_SP,ID_Danhmuc,TenSP,ID_KM,SoLuong,GiaBan,NhanHieuSP,MauSP,MoTaSP,Anh")] SanPham sanPham)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_SP,ID_Danhmuc,TenSP,ID_KM,SoLuong,GiaBan,NhanHieuSP,MauSP,MoTaSP,Anh")] SanPham sanPham)
        {
            if (ModelState.IsValid)
            {
